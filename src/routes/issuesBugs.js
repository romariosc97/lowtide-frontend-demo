    ...
    <div>
      ...
      <main className="main-wrapper">
        ...
        <div className="page-newContainer">
          <Grid container className="issues-bugs">
            ...
            <Grid item xs={6} className="form">
              <form method="POST" action="">
                ...
                <div className="fields">
                  <TextField margin="normal" className="half" label="Name" variant="outlined" size="small"/>
                  <TextField margin="normal" className="half" label="Email" variant="outlined" size="small"/>
                </div>
                <div className="text-area">
                  <TextField margin="normal" fullWidth label="Description" variant="outlined" multiline rows="6" />
                </div>
